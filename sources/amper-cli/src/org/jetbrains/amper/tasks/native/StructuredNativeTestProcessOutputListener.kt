...
internal class StructuredNativeTestProcessOutputListener(
    ...
    override fun onStdoutLine(line: String, pid: Long) = parse(line, stderr = false)

    override fun onStderrLine(line: String, pid: Long) = parse(line, stderr = true)

    private fun parse(line: String, stderr: Boolean) {
    ...
    private val visitor = object : DefaultServiceMessageVisitor() {
        ...
        override fun visitTestSuiteStarted(message: TestSuiteStarted) {
            ...
            val testId = message.findTestIdOrAddToNonFlowStack { it.suiteName }
    ...
    private fun BaseTestSuiteMessage.testId(): TestId {
        ...
        return nonFlowIdStack.lastOrNull() ?: TestId(suiteName)
    }
