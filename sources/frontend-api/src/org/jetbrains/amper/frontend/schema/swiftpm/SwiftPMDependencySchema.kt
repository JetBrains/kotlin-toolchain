...
sealed class SwiftPMDependencySchema : SchemaNode() {
    ...
    class Remote : SwiftPMDependencySchema() {
        ...
        override val packageName: String by referenceValue<String>(::repository, "package", RepoPathToPackageNameTransform())
    ...
    class Local : SwiftPMDependencySchema() {
        ...
        override val packageName: String by referenceValue<String>(::path, "foo", PathToPackageNameTransform())
        override val traits: List<String> by value<List<String>>(emptyList())
    }
}